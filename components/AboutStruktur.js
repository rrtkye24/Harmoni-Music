...
<h1 className={styles.nmablog}>Daftar Peserta Musyawarah Kerja Nasional</h1> 
<div className={styles.accordion}>
    <div className={styles.contoh}>
      <input type="checkbox" name="example_acordion" id="section1" className={styles.accordion__input}/>
      <label htmlFor="section1" className={styles.accordion__label}>MAJELIS PUSAT</label>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section2" className={styles.accordion__input}/>
      <label htmlFor="section2" className={styles.accordion__label}>MAJELIS PEMBINA ROHANI</label>
      <div className={styles.accordion__content}>
        <table className={styles.table1}>
          <tr>
              <th>No</th>
     ...
     <div>
      <input type="checkbox" name="example_acordion" id="section3" className={styles.accordion__input}/>
      <label htmlFor="section3" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 1 – SUMATERA UTARA & ACEH </label>
      <div className={styles.accordion__content}>
        <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section4" className={styles.accordion__input}/>
      <label htmlFor="section4" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 2 – RIAU	 </label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section5" className={styles.accordion__input}/>
      <label htmlFor="section5" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 3 – DKI, BANTEN, LAMPUNG, BABEL	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section6" className={styles.accordion__input}/>
      <label htmlFor="section6" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 4 – JAWA BARAT </label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section7" className={styles.accordion__input}/>
      <label htmlFor="section7" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 5 – JAWA TENGAH & DI. YOGYAKARTA	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section8" className={styles.accordion__input}/>
      <label htmlFor="section8" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 6 – JAWA TIMUR & BALI 	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
...
<tr>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section10" className={styles.accordion__input}/>
      <label htmlFor="section10" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 7 – SULAWESI SELATAN & SULAWESI TENGAH</label>
      <div className={styles.accordion__content}>
       <table className={styles.table1}>
          <tr>
              <th>No</th>
...
<tr>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section11" className={styles.accordion__input}/>
      <label htmlFor="section11" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 8 – SULAWESI UTARA	 	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
...
<tr>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section12" className={styles.accordion__input}/>
      <label htmlFor="section12" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 9 - KALIMANTAN		</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>136</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section13" className={styles.accordion__input}/>
      <label htmlFor="section13" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 10 – KEPULAUAN RIAU	 	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
    ...
    <div>
      <input type="checkbox" name="example_acordion" id="section14" className={styles.accordion__input}/>
      <label htmlFor="section14" className={styles.accordion__label}>MAJELIS DAERAH FILADELFIA 11 – PAPUA, PAPUA BARAT, MALUKU & MALUKU UTARA	 	</label>
      <div className={styles.accordion__content}>
      <table className={styles.table1}>
          <tr>
              <th>No</th>
