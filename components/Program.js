...
import { GiPianoKeys, GiMicrophone, GiGuitarBassHead, GiGuitar, GiViolin } from 'react-icons/gi'
function ProgramCard({ image, badge, title, desc, url, urln }) {
                    ...
                    <Stack direction={['column']}>
                        ...
                        <Popover onClick={url}>
                            ...
                            <PopoverContent>
                                <PopoverArrow />
                                <PopoverCloseButton />
                                <PopoverHeader>Pengumuman !</PopoverHeader>
                                <PopoverBody>Program ini belum tersedia</PopoverBody>
                            </PopoverContent>
                        </Popover>
                    </Stack>
                </Stack>
        ...
        <Box
            ...
            <Slider {...settings} ref={(slider) => setSlider(slider)}>
                <ProgramCard
                    ...
                    urln='https://wa.me/6281271886601?text=Hallo%20,saya%20telah%20mengunjungi%20website%20Harmony%20Music%20dan%20tertarik%20untuk%20mendaftar%20dan%20bergabung%20bersama%20Harmony%20Music'
                />
                <ProgramCard
                    image={<GiMicrophone size={150} />}
                    badge={'Baru'}
                    title={'VOKAL'}
                ...
                />
                <ProgramCard
                    image={<GiGuitarBassHead size={150} />}
                    badge={'Belum Tersedia'}
                    title={'BASS'}
